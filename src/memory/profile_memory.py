...
def update_profile(profile: Dict, conversation):
    ...
    prompt = (
        ...
        "1. **Analysis Rules**:\n"
        "   - Only modify or add attributes mentioned in the 'Recent Conversation' that should be added to the user's profile.\n"
        "   - Retain all attributes from the 'Current User Profile' that are not explicitly referenced in the 'Recent Conversation'.\n"
        "   - Do not infer or guess any information. Use only explicit details about user.\n\n"
        "2. **Attribute Types**:\n"
